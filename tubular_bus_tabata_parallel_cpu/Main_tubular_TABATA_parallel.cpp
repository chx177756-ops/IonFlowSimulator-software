...
int main(int argc, char *argv[])
{
    ...
    PerfTimer t_mesh_read, t_init_setup, t_poisson, t_grad_calc, t_upwind_find, t_tabata, t_output, t_loop_overhead;
    ...
    if (run_main_loop) 
    {
        ...
        while (rela_error_E >= tolerance_E)
        {
            ...
            // Tabata 线性系统: 无 epsilon 项 (与 TAKUMA 3D 的求解差异仅在核心方法)
